...
assert (
    spark.sql("SHOW TABLES")
    .filter("tableName == 'bronze_enhanced_temp'")
    .first()["isTemporary"]
    == True
...
assert (
    spark.sql("SHOW TABLES")
    .filter("tableName == 'customer_count_temp'")
    .first()["isTemporary"]
    == True
), "Table is not temporary"
...
assert (
    spark.sql("show tables")
    .filter("tableName == 'gold_customer_count_by_state'")
    .first()["isTemporary"]
    == False
), "Table is temporary"
